import pytest
from pipeline_common.types import BoundingBox, Detection
from pipeline_common.metrics import compute_metrics, MetricsResult
...
class TestComputeMetrics:
    ...
    def test_metrics_result_meets_threshold(self):
        r = MetricsResult(
            precision=0.9, recall=0.85, f1=0.874, true_pos=17, false_pos=2, false_neg=3
        )
